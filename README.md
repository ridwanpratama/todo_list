...
## General info
This is a to do list web app made using Laravel framework.
...
1. Clone this project `https://github.com/ridwanz02/todo_list.git`
2. Go to project folder `cd todo_list`
